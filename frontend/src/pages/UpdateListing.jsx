...
const UpdateListing = () =>
{
    ...
    React.useEffect(()=>{
        const getUpdateListing =async()=>
        {
            ...
            if(!res.ok)
            {
                toast.error("Something Wrong in data fetching");
                return;
    ...
    const handleSubmit = async()=>
    {
        try {
            ...
            const res = await fetch(`/api/listing/update/${lid}`,
                {
                    method:"PATCH",
                    headers:{
    ...
    return(
        <main className="max-w-6xl mx-auto">
            <h1 className="text-3xl text-center font-medium my-6">Update Listing</h1>
            ...
            <div className="flex flex-col px-2 py-4 gap-4">
                ...
                <div className="flex gap-2" >
                    ...
                    <button className="p-2 text-green-700 border border-green-700 rounded-sm hover:bg-green-700 hover:text-white " onClick={handleFileInput} >
                        {
